...
2. Create the seven private mirrors, install the mirror-only release App, run
...
3. Make `AtomsPHP/atoms` and all seven mirrors public.
...
5. Push the immutable monorepo tag `v0.1.0` and approve the protected release
   environment. Confirm npm, all seven mirror tags, and the GitHub release.
