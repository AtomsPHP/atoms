...
Packagist requires one VCS repository per Composer package. The seven package
...
seven mirrors, derives each mirror commit with `git subtree split`, and pushes
